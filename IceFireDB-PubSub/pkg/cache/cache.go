...
var maxItemsCountErr = errors.New("reach max items count.")
...
// Determine whether the amount of data inside the map data structure has reached the maximum number limit
